...
parser.add_argument('--precision', type=str, default='auto', choices=['auto', 'bf16', 'fp16', 'fp32'],
                    help='Mixed precision training: auto (GPU auto-detect), bf16, fp16, or fp32')
...
trainer_args = transformers.Seq2SeqTrainingArguments(
    ...
    # Precision control: auto (GPU detect), bf16, fp16, or fp32
    bf16=True if (args.precision == 'bf16' or (args.precision == 'auto' and torch.cuda.is_bf16_supported() and args.load_bit == 16)) else False,
    fp16=True if (args.precision == 'fp16' or (args.precision == 'auto' and not torch.cuda.is_bf16_supported() and args.load_bit == 16)) else False,
